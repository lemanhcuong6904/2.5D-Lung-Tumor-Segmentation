"""Run TransUNet inference on the NSCLC-Radiogenomics test split."""
...
CFG = dict(BASE_CFG) | {
    ...
    "SPLIT_PATH": str(ROOT_DIR / "data" / "nsclc_radiogenomics" / "config" / "test.txt"),
    "PROCESSED_ROOT": str(ROOT_DIR / "data" / "nsclc_radiogenomics" / "processed"),
    "NIFTI_ROOT": str(ROOT_DIR / "data" / "nsclc_radiogenomics" / "nifti"),
    "OUTPUT_DIR": str(ROOT_DIR / "output" / "nsclc_radiogenomics_2.5d-5_final" / "test"),
    "NUM_SLICES": 5,
